import { Settings, MapPin, GraduationCap, Link as LinkIcon, Plus, ExternalLink, Check } from "lucide-react";
...
const UserWidget = ({ userId, picturePath }) => {
  ...
  useEffect(() => {
    getUser();
  }, [userId]); // Add userId as dependency to reload when viewing different profiles
